...
function makeRegistry(allowedDirs = []) {
...
describe('ToolRegistry.register', () => {
    it('inline handler takes priority over MCP', async () => {
        const registry = makeRegistry();
        let called = false;
        registry.register({ name: 'custom_tool', description: 'test', inputSchema: {} }, async (_input) => {
            called = true;
...
//# sourceMappingURL=builtin-tools.test.js.map